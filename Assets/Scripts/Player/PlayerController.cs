...
public class PlayerController : MonoBehaviour
{
    ...
    public float step_Length = 0.0001f;
    ...
    void Awake()
    {
       ...
       delta_Position = new List<Vector3>() {
       		...
       		new Vector3(0f,0f,step_Length), //UP
       		new Vector3(step_Length,0f), //Right
       		new Vector3(0f,0f,-step_Length) //Down
       };
    ...
    void InitPlayer() {
    	...
    	switch(direction) {
    		...
    		case PlayerDirection.UP:
    			...
    			nodes[2].position = nodes[0].position - new Vector3(0f,0f ,Metrics.NODE );
    			break;
